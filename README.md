...
| Breadboard | 1 | Used to connect and prototype the circuit |
| Jumper wires | 1 set | Used for connections between the Arduino, sensor, servo, and LCD |
| USB cable / 5V power source | 1 | Used to power and upload firmware to the Arduino |
